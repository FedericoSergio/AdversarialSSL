...
def make_optimizer_and_schedule(args, model, checkpoint, params, loader):
    """
...
def train_model(args, model, loaders, *, checkpoint=None, dp_device_ids=None,
    ...
    opt, schedule = make_optimizer_and_schedule(args, model, checkpoint, update_params, train_loader)
